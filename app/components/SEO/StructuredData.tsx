...
export function LocalBusinessSchema({ branch }: LocalBusinessSchemaProps) {
  const schema = {
    ...
    "@type": "BeautySalon",
    "@id": `https://www.vibeunisexsalon.in/branches/${branch.slug}#localbusiness`,
    name: branch.name,
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Home",
        item: "https://www.vibeunisexsalon.in",
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Branches",
        item: "https://www.vibeunisexsalon.in/branches",
      },
      {
        "@type": "ListItem",
        position: 3,
        name,
        item: `https://www.vibeunisexsalon.in/branches/${slug}`,
      },
    ],
  };
