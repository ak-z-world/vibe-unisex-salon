...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://vibe-unisex-salon.vercel.app/branches",
  },
  openGraph: {
    title: "Best Premium Unisex Salon Branches in Chennai | Vibe Unisex Salon",
    description:
    ...
    url: "https://vibe-unisex-salon.vercel.app/branches",
...
function generateStructuredData() {
  ...
  const breadcrumb = {
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Home", item: "https://vibe-unisex-salon.vercel.app" },
      { "@type": "ListItem", position: 2, name: "Branches", item: "https://vibe-unisex-salon.vercel.app/branches" },
    ],
  };
