...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://vibeunisexsalon.com/branches",
  },
  openGraph: {
    title: "Best Premium Unisex Salon Branches in Chennai | Vibe Unisex Salon",
    description:
    ...
    url: "https://vibeunisexsalon.com/branches",
...
function generateStructuredData() {
  ...
  const breadcrumb = {
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Home", item: "https://vibeunisexsalon.com" },
      { "@type": "ListItem", position: 2, name: "Branches", item: "https://vibeunisexsalon.com/branches" },
    ],
  };
